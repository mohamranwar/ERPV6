      ...
      >
        <ResponsiveContainer width="100%" height={210}>
          <BarChart data={salesData} margin={{ top: 4, right: 12, left: 0, bottom: 4 }}>
            ...
            <Bar {...chartProps} dataKey="forecast" name="Forecast" fill={chartColors().actual} radius={[3, 3, 0, 0]} maxBarSize={26} />
          ...
          <>
            <ResponsiveContainer width="100%" height={190}>
              <BarChart data={byLine} margin={{ top: 4, right: 12, left: 0, bottom: 4 }}>
                ...
                <Tooltip formatter={(v: number, n: string) => [`${Math.round(v).toLocaleString()} PCS`, n]} />
                <Legend wrapperStyle={{ fontSize: 11 }} />
                <Bar {...chartProps} dataKey="produced" name="Produced" fill={chartColors().actual} radius={[3, 3, 0, 0]} maxBarSize={30} />
          ...
          {orderStatuses.length === 0 ? (
            ...
            <ResponsiveContainer width="100%" height={180}>
              <BarChart data={orderStatuses} layout="vertical" margin={{ top: 4, right: 24, left: 8, bottom: 4 }}>
                ...
                <Bar {...chartProps} dataKey="count" fill={chartColors().actual} radius={[0, 4, 4, 0]} maxBarSize={24} />
              </BarChart>
            </ResponsiveContainer>
          )}
        </Section>
