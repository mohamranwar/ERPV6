...
const LINE_STATUS_STYLE: Record<ExportLineStatus, string> = {
  ...
  staged:        'bg-brand-50 text-brand-800 border-brand-300',
  ...
  return (
    <div className="space-y-6 pb-12">
                    ...
                    return (
                      <tr key={a.productId} className={a.overAllocated ? 'bg-red-50/40' : ''}>
                        <td className="px-3 py-2">
                          <span className="font-mono font-bold text-brand-700">{prod?.sku ?? a.productId}</span>
      ...
      <div className="card-elevated p-4 space-y-4">
        <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <select aria-label="Filter by country"
              ...
              className="px-3 py-1.5 text-xs font-medium border border-slate-300 rounded-lg bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-brand-500"
            >
        ...
        {searchQuery && (
          <div className="text-xs text-brand-700 bg-brand-50 border border-brand-100 px-3 py-1.5 rounded-lg flex items-center justify-between">
            <span>
            ...
            <button
              ...
              className="font-bold underline hover:text-brand-900 text-[11px]"
            >
              Clear Search
            </button>
          </div>
                ...
                {filteredExports.map((order) => {
                  ...
                  return (
                    <React.Fragment key={order.id}>
                      {/* Parent Order Row */}
                      <tr className={`hover:bg-slate-50/80 transition-colors ${isSelected ? 'bg-brand-50/40' : ''}`}>
                        ...
                        <td className="py-3 px-3 font-semibold text-slate-900">
                          <div className="flex items-center gap-1.5">
                            <span className="font-mono text-xs text-brand-700 font-bold">{order.order_number}</span>
                                    ...
                                    {(order.items || []).map((li, idx) => {
                                      ...
                                      return (
                                        <tr key={li.id || idx} className="hover:bg-slate-50/90">
                                          <td className="py-2 px-2 font-mono font-bold text-brand-700">{prod?.sku || li.product_id}</td>
          ...
          <div ref={orderModalRef} className="bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <form onSubmit={handleSaveRecord} className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <select aria-label="Country code"
                      ...
                      className="w-full px-3 py-2 text-xs border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:outline-none bg-white"
                      required
                    >
                      {COUNTRY_OPTIONS.map((c) => (
                        <option key={c.code} value={c.code}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <input aria-label="Target ship date"
                      ...
                      className="w-full px-3 py-2 text-xs font-semibold text-brand-900 border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:outline-none"
                      required
                    />
                  </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between border-b border-slate-100 pb-1">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 text-xs font-semibold text-brand-600 hover:text-brand-800 bg-brand-50 hover:bg-brand-100 px-2.5 py-1 rounded-lg transition-colors"
                  >
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
                        <div className="sm:col-span-2">
                          ...
                          <select aria-label="Product id"
                            ...
                            className="w-full px-2.5 py-1.5 text-xs border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:outline-none bg-white font-medium"
                          >
                            {products.map((p) => (
                        ...
                        <div>
                          ...
                          <input aria-label="Forecast qty"
                            ...
                            className="w-full px-2.5 py-1.5 text-xs font-mono border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:outline-none"
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <input aria-label="Confirmed order qty"
                            ...
                            className="w-full px-2.5 py-1.5 text-xs font-mono font-bold border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:outline-none text-slate-900"
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                        ...
                        <div>
                          ...
                          <input aria-label="Notes"
                            ...
                            className="w-full px-2.5 py-1.5 text-xs border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:outline-none"
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-200">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 text-xs font-semibold text-white bg-brand-600 hover:bg-brand-700 rounded-lg shadow-sm transition-colors"
                >
                  Save Export Order
                </button>
              </div>
        ...
        <div className="fixed inset-0 z-50 bg-slate-900/30 backdrop-blur-xs flex justify-end" role="dialog" aria-modal="true" aria-label="Export order details">
          <div ref={drawerRef} className="bg-white w-full max-w-xl h-full shadow-2xl border-l border-slate-200 flex flex-col overflow-hidden animate-in slide-in-from-right duration-200">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              <div className="bg-gradient-to-r from-slate-900 to-brand-950 text-white rounded-xl p-4 shadow-md space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-xs text-brand-200 font-semibold uppercase tracking-wider flex items-center gap-1.5">
                  ...
                  <div className="space-y-3">
                        ...
                        <div key={li.id || idx} className="bg-slate-50 border border-slate-200 rounded-xl p-3 space-y-2">
                          ...
                          <div className="flex items-center gap-2">
                            <div className="flex-1 bg-slate-200 h-1.5 rounded-full overflow-hidden">
                              <div
                                className={`h-1.5 rounded-full ${li.pct >= 100 ? 'bg-emerald-500' : 'bg-brand-500'}`}
                                style={{ width: `${li.pct}%` }}
                              />
                            </div>
                    ...
                    <div className="border border-slate-300 rounded-xl p-3 bg-white space-y-2">
                      ...
                      <div className="flex-1 bg-slate-200 h-2 rounded-full overflow-hidden">
                        <div
                          className={`h-2 rounded-full ${t.readinessPct >= 100 ? 'bg-emerald-500' : 'bg-brand-500'}`}
              ...
              <div className="bg-slate-50 rounded-xl p-4 border border-slate-200 text-xs space-y-2">
                ...
                <div className="flex justify-between py-1 border-b border-slate-200">
                  ...
                  <span className="font-mono font-bold text-brand-700">{activeDrawerRecord.lc_reference || 'N/A'}</span>
                </div>
