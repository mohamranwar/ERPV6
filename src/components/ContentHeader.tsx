...
export default function ContentHeader({
  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b-2 border-slate-200/90 pb-5 mb-8 pt-1">
      <div className="space-y-1.5 text-start min-w-0 pr-4">
